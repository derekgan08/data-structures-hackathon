...
*/
	...
	int PlaneWreck1::choose(PlaneWreck1 &wreck1) {
		int temp;
		string direction;
		cout << "\nChoose your direction. South(s), or 'quit' to save and quit." << endl;
...
*/
	...
	int PlaneWreck2::choose(PlaneWreck2 &wreck2) {
		int temp;
		string direction;
		cout << "\nChoose your direction. South(s), West(w), or 'quit' to save and quit." << endl;
...
*/
	...
	int River::choose(River &river) {
		int temp;
		string direction;
		cout << "\nChoose your direction. East(e), or 'quit' to save and quit." << endl;
...
*/
	...
	int Forest::choose(Forest &forest) {
		int temp;
		string direction;
		cout << "\nChoose your direction. North(n), East(e), or 'quit' to save and quit." << endl;
		...
		do {
			...
			if(direction=="n") {
				...
				temp=-1;
				cout << "You can only go North or East." << endl;
			}
		} while(temp!=5 && temp!=0);
		return 0;//random return[FOR PROGRAMMER];
	}
...
*/
	...
	int Village::choose(Village &village) {
		int temp;
		string direction;
		cout << "\nChoose your direction. North(n), West(w), or 'quit' to save and quit." << endl;
		...
		return 122;//random return[FOR PROGRAMMER];
	}